...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.colors_hp = [(255, 0, 255), (255, 0, 0), (0, 0, 255), 
        ...
        self.ec = [(255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255),
                   (255, 0, 0), (0, 0, 255), (255, 0, 255), (0, 0, 255),
                   (255, 0, 0), (255, 0, 0), (0, 0, 255), (0, 0, 255),
                   (255, 0, 0), (0, 0, 255), (255, 0, 255), (0, 0, 255),
                   (255, 0, 0), (255, 0, 0), (0, 0, 255), (0, 0, 255),
                   (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255),
        ...
        self.colors_hp = [(255, 0, 255), (255, 0, 0), (0, 0, 255),
                          ...
                          (255, 0, 0), (0, 0, 255), (0, 255, 0), (0, 255, 255), (255, 255, 0)]
  ...
  def add_coco_bbox(self, bbox, cat, conf=1, show_txt=True, img_id='default'):
    print("add_coco_bbox methid added")
    ...
    cv2.rectangle(
      self.imgs[img_id], (bbox[0], bbox[1]), (bbox[2], bbox[3]), c, 2, lineType=cv2.LINE_8)
    if show_txt:
      cv2.rectangle(self.imgs[img_id],
                    (bbox[0], bbox[1] - cat_size[1] - 2),
                    (bbox[0] + cat_size[0], bbox[1] - 2), c, -1, lineType=cv2.LINE_8)
      cv2.putText(self.imgs[img_id], txt, (bbox[0], bbox[1] - 2), 
                  font, 0.5, (0, 0, 0), thickness=1, lineType=cv2.LINE_8)

  def add_coco_hp(self, points, img_id='default'):
    print('add_coco_hp method called')
  ...
  def show_all_imgs(self, pause=False, time=0):
    if not self.ipynb:
      ...
      for i, v in self.imgs.items():
        #resize_down = cv2.resize(v, down_points, interpolation=cv2.INTER_LINEAR)
